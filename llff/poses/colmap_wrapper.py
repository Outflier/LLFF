...
def run_colmap(basedir, match_type):
    ...
    match_output = (subprocess.check_output(exhaustive_matcher_args,
                                            universal_newlines=True))
    ...
    mapper_args = [
        ...
        os.path.join(
            basedir,
            'sparse'),  # --export_path changed to --output_path in colmap 3.6
        '--Mapper.num_threads',
        '16',
    ...
    map_output = (subprocess.check_output(mapper_args,
                                          universal_newlines=True))
